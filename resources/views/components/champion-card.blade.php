...
{{--    champion-card   --}}
        <div class="w-60 h-72 bg-gray-light border-2 border-gray-600 hover:bg-gray-500"> 
        ...
        {{-- img + name,title --}}
                ...
                <div class="text-center ">
                    <h1 class="text-xl font-bold text-black font-apple">{{ $champion->name }}</h1>
                    </div>

                    <div class="flex justify-center py-4"> 
                        <img style="width: 90px" src="{{ 'https://ddragon.leagueoflegends.com/cdn/11.15.1/img/champion/'. $champion->img }}" >
                    </div>
        {{-- name + title --}}
                    <div class="text-center ">
                        <h2 class="text-sm">{{ $champion->title }}</h2>
                    </div>
                </div>
